...
int LiaisonSimulateur::connexion(String adresse) 
{
...
bool LiaisonSimulateur::isActif() 
{
  String contenu = "";
...
Uart* LiaisonSimulateur::getLiaisonBT() 
{
  return serialBT;
}
...
int LiaisonSimulateur::modeConnexion() 
{
  String contenu = "";
...
int LiaisonSimulateur::motDePasse() 
{
  String contenu = "";
...
int LiaisonSimulateur::initialisation() 
{
  String contenu = "";
...
int LiaisonSimulateur::appairage(String adresse) 
{
  String contenu = "";
...
int LiaisonSimulateur::bind(String adresse) 
{
  String contenu = "";
  Serial.println("Bind");
...
int LiaisonSimulateur::modeDeconnecte() 
{
  String contenu = "";
...
int LiaisonSimulateur::lien(String adresse) 
{
  String contenu = "";
  Serial.println("Link");
